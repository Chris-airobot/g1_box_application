...
def create_task_constants(
    ...
    *,
    ...
    namespace.ROBOT_URDF_FILE = _resolve_asset_path(getattr(namespace, "ROBOT_URDF_FILE", None))
    namespace.OBJECT_URDF_FILE = _resolve_asset_path(getattr(namespace, "OBJECT_URDF_FILE", None))
    namespace.OBJECT_MESH_FILE = _resolve_asset_path(getattr(namespace, "OBJECT_MESH_FILE", None))
    namespace.OBJECT_URDF_TEMPLATE = _resolve_asset_path(getattr(namespace, "OBJECT_URDF_TEMPLATE", None))
    namespace.SCENE_XML_FILE = _resolve_asset_path(getattr(namespace, "SCENE_XML_FILE", None))
...
def run_simulator(args_cli: DataConversionConfig):
    ...
    # Prepare optional MuJoCo viewer
    viewer = None
