...
JOINTS_MAPPINGS = {
    ...
    ("stickman", "g1"): {
        ...
        # "left_hand_thumb": "left_pinky_link",
        # "right_hand_thumb": "right_pinky_link",
        # "left_hand_pinky": "left_thumb_link",
        # "right_hand_pinky": "right_thumb_link",
        "left_foot_tip": "left_ankle_roll_sphere_5_link",
        "right_foot_tip": "right_ankle_roll_sphere_5_link",
    },
    ("hiphi", "g1"): {
        "Spine1": "pelvis_contour_link",
        "LeftUpLeg": "left_hip_pitch_link",
...
TOE_NAMES_BY_FORMAT = {
    ...
    "hiphi": ["LeftToeBase", "RightToeBase"],
    "smplx": ["L_Foot", "R_Foot"],
    "stickman": ["left_foot_tip", "right_foot_tip"],
}
...
DEMO_JOINTS_REGISTRY: dict[str, list[str]] = {
    ...
    "hiphi": HIPHI_DEMO_JOINTS,
    "smplx": SMPLX_DEMO_JOINTS,
    "stickman": STICKMAN_DEMO_JOINTS,
}
