...
g1_29dof_wbt_reward_w_object = RewardManagerCfg(
    terms={
        **g1_29dof_wbt_reward.terms,
        ...
        # Task rewards (Carrying)
        "task_walk_to_object": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:task_walk_to_object",
            params={"sigma": 0.5, "near_threshold": 0.5},
            weight=1.0,
        ),
        "task_carry_object": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:task_carry_object",
            params={"sigma": 0.3},
            weight=1.0,
        ),
        "task_put_object": RewardTermCfg(
            func="holosoma.managers.reward.terms.wbt:task_put_object",
            params={"sigma": 0.1, "activate_dist": 0.1},
            weight=1.0,
        ),
    }
)
